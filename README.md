...
4. **Pricing** — Starter ₱5,000 / Business ₱12,000 / E-Commerce ₱20,000 (starting prices), each including a free 1st-year domain name, with the Business and E-Commerce tiers also including a free business email. Adjust in the Pricing section of `index.html` if your rates change — and double-check with your domain/email provider what "free 1st year" actually costs you before offering it at scale.
