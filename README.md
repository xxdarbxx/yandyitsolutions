...
4. **Pricing** — Starter ₱2,500 / Business ₱6,000 / E-Commerce ₱12,000 (starting prices). All tiers include a free 1st-year domain name; Business and E-Commerce include an admin dashboard; only E-Commerce includes free business email. Adjust in the Pricing section of `index.html` if your rates change — and double-check with your domain/email provider what "free 1st year" actually costs you before offering it at scale.
